...
- [Вариант 1 — локально (npm, stdio)](#вариант-1--локально-npm-stdio)
- [Вариант 2 — удалённо (HTTP)](#вариант-2--удалённо-http)
- [Универсальная настройка (любой MCP-клиент)](#универсальная-настройка-любой-mcp-клиент)
- [Инструменты](#инструменты)
- [Шаблоны](#шаблоны)
- [Поддерживаемые платформы](#поддерживаемые-платформы)
- [Примеры запросов](#примеры-запросов)
- [Конфигурация](#конфигурация)
- [Самостоятельный хостинг удалённого сервера](#самостоятельный-хостинг-удалённого-сервера)
